...
import slide1 from '../Pic/Rectangle 201.png'
import slide2 from '../Pic/Rectangle 202.png'
import slide3 from '../Pic/Rectangle 203.png'
...
function Apply() {
  ...
  return (
    <>
      ...
      <Carousel style={{ width: '410px', scale: '0.8', WrapFlow: 'auto', backgroundPosition: 'center', margin: 'auto', objectFit: 'cover', alignItems: 'center', justifyContent: 'center', display: 'flex' }}>
        <Carousel.Item style={{}}>
          <img
            className=""
            src={slide1}
      ...
      <hr style={{ height: '1px', backgroundColor: '#000', width: '35%', borderRadius: '50%', opacity: '0.5', margin: 'auto' }} />
